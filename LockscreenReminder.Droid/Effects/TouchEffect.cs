...
using System.Linq;
using Android.Views;
using LockscreenReminder.Droid.Effects;
using LockscreenReminder.Events;
using LockscreenReminder.Models.Touch;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;

[assembly: ResolutionGroupName("LockscreenReminder.Effects")]
[assembly: ExportEffect(typeof(TouchEffect), "TouchEffect")]
namespace LockscreenReminder.Droid.Effects
{
	public class TouchEffect : PlatformEffect
    {
		Android.Views.View view;
		Element formsElement;
		LockscreenReminder.Effects.TouchEffect libTouchEffect;
		bool capture;
		...
		protected override void OnAttached()
		{
			...
			LockscreenReminder.Effects.TouchEffect touchEffect =
				                  (LockscreenReminder.Effects.TouchEffect)Element.Effects.
				                  FirstOrDefault(e => e is LockscreenReminder.Effects.TouchEffect);
